# -*- coding: utf-8 -*-
#
# tumai-intro-rl documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = "https://github.com/appliedAI-Initiative/tumai-intro-rl/blob/develop"
    if domain != "py":
        return None
    if not info["module"]:
        return None
...
htmlhelp_basename = "tumai-intro-rl_doc"
...
man_pages = [
    ("index", "tumai-intro-rl", "", ["appliedAI Transferlab"], 1)
]
